        ...
        Ok(self.plans.get_or_prepare(batch, || {
            ...
            unsafe {
                self.engine.prepare(
                    ...
                    &[(
                        self.outputs[0],
                        TensorDesc::new(DType::F32, vec![batch, crate::EMBEDDING])?
...
fn kernel_source(name: &str) -> &'static str {
    match name {
        ...
        "conv3x3_f16_wmma_bnprelu" => include_str!("../kernels/conv3x3_f16_wmma_bnprelu.loom"),
        "conv3x3_f16_wmma_prelu" => include_str!("../kernels/conv3x3_f16_wmma_prelu.loom"),
        "conv3x3_n128_f16_wmma" => include_str!("../kernels/conv3x3_n128_f16_wmma.loom"),
        "conv3x3_n128_f16_wmma_add" => include_str!("../kernels/conv3x3_n128_f16_wmma_add.loom"),
        "conv3x3_n128_f16_wmma_bnprelu" => {
            include_str!("../kernels/conv3x3_n128_f16_wmma_bnprelu.loom")
        }
        "hwc_u8_to_nhwc_f16" => include_str!("../kernels/hwc_u8_to_nhwc_f16.loom"),
        "matmul_splitk_f16_wmma" => include_str!("../kernels/matmul_splitk_f16_wmma.loom"),
        "splitk_reduce_f32" => include_str!("../kernels/splitk_reduce_f32.loom"),
